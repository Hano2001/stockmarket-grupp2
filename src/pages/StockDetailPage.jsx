...
export const StockDetailPage = props => {
  ...
  const stockInfo = useFetch(
    `https://market-data-collector.firebaseio.com/market-collector/markets/${market}/${stock}.json`
  );
  ...
  return (
    <div>
      ...
      <div className="row">
        {!stockInfo ? <p>Loading...</p> : <Details props={stockInfo} />}
      </div>
    </div>
  );
};
